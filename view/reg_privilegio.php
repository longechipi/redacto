                ...
                <div class="row">
                    <div class="col-md-4 col-sm-12">
                        <div class="form-group">
                            <label>Nombre del Privilegio</label> <span class="text-danger">(*)</span>
                            <input type="text" class="form-control" name="nom_pri" style="text-transform:uppercase" required>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 col-sm-12">
                        <div class="form-group">
                            ...
                            <select name="sta_pri" id="sta_pri" class="form-control" required>
...
$(document).ready(function(){
    $('#banco').submit(function(e){
        e.preventDefault();
        $.ajax({
            url: '../model/privilegio/reg_privilegio.php',
            type: 'POST',
